...
public class AuthenFillter implements Filter {
    ...
    public AuthenFillter() {
        ...
        USER.add("cart.jsp");
        USER.add("create.jsp");
        USER.add("invalid.html");
        USER.add("AddToCartController");
        USER.add("BookingController");
        USER.add("CartController");
        USER.add("CreateController");
        USER.add("DetailController");
        USER.add("HomeController");
        ...
        ADMIN.add("DeleteADController");
        ADMIN.add("admin.jsp");
        ADMIN.add("updateRoom.jsp");
        ADMIN.add("UpdateADController");
        ADMIN.add("UpdateRommController");
    }
...
//		chain.doFilter(request, response);
        try {
            ...
            if (uri.contains(".jpg") || uri.contains(".png") || uri.contains("gif")) {
                ...
                if (uri.contains("login.html") || uri.contains("login.jsp") || uri.contains("MainController")
                        || uri.contains("LoginController") || uri.contains("style.css")) {
                    chain.doFilter(request, response);
                    return;
                }
